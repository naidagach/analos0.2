...
function Main() {
  return (
    <div className='bg-[#020604] py-32 p-4'>
        <section className=' container mx-auto flex flex-col m:flex-row m:items-center m:justify-between'>
            <div className='from-left m:w-[45%]'>
                <div className='bg-linear-to-r from-[#0ea674]/20 to-[#17ff9a]/20 rounded-full px-4 py-2 w-[max-content] text-[#17ff9a] flex items-center gap-2 border border-[#114f36]'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-sparkles w-4 h-4" aria-hidden="true">
            ...
            <div className='from-right relative max-s:overflow-x-hidden py-5 m:mr-10 m:w-[48%]'>
                <motion.div 
                ...
                >
                    <div className='w-full h-full bg-black rounded-3xl flex items-center justify-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-zap w-40 h-40 text-[#17ff9a]" aria-hidden="true">
        ...
        <section className='container mx-auto my-10'>
            <div className='grid grid-cols-2 s:grid-cols-4 gap-4 mb-30'>
                ...
                <div className='bg-linear-to-br from-[#0ea674]/10 to-[#17ff9a]/10 backdrop-blur-xl rounded-2xl p-6 border border-[#0ea674]/30 text-center'>
                    <p className='text-[#17ff9a] mb-4 '><BsFillRocketTakeoffFill className='mx-auto' /></p>
            ...
            <div className='flex flex-col s:flex-row gap-4'>
                <div className=' hover:shadow-custom shadow-[#0ea674]/50 hover:bg-linear-to-r from-[#0ea67380] to-[#17ff9a80] backdrop-blur-xl rounded-2xl p-8 border border-[#0ea674]/30 hover:border-[#0ea674] hover:translate-y-[-10px] duration-200'>
                    <div className="w-16 h-16 bg-linear-to-br from-[#0ea674] to-[#17ff9a] rounded-xl flex items-center justify-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-shield w-8 h-8 text-white" aria-hidden="true">
                ...
                <div className=' hover:shadow-custom shadow-[#0ea674]/50 hover:bg-linear-to-r from-[#0ea67380] to-[#17ff9a80]  backdrop-blur-xl rounded-2xl p-8 border border-[#0ea674]/30 hover:border-[#0ea674] hover:translate-y-[-10px] duration-200'>
                    <div className="w-16 h-16 bg-linear-to-br from-[#0ea674] to-[#17ff9a] rounded-xl flex items-center justify-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-trending-up w-8 h-8 text-white" aria-hidden="true">
                            <path d="M16 7h6v6"></path>
                            <path d="m22 7-8.5 8.5-5-5L2 17"></path>
                        </svg>
                    </div>
