                ...
                <div className='bg-linear-to-r from-[#0ea674]/20 to-[#17ff9a]/20 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-[#0ea674]/30'>
                    ...
                    <div className='flex flex-col s:flex-row s:justify-around gap-4 justify-center items-center'>
                        <div className='flex flex-col items-center'>
                            <div className='w-20 h-20 bg-linear-to-br from-[#0ea674] to-[#17ff9a] rounded-2xl flex items-center justify-center mx-auto mb-4'>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#fff" height="28px" width="28px" viewBox="0 0 511.999 511.999">
                            ...
                            <p className='text-[#17ff9a] mb-2'>1,000,000,000</p>
                            <p className='text-[#b6bdb9]'>Total Supply</p>
                        </div>
                        <div className='flex flex-col items-center'>
                            <div className='w-20 h-20 bg-linear-to-br from-[#0ea674] to-[#17ff9a] rounded-2xl flex items-center justify-center mx-auto mb-4'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 24 24" fill="#fff">
                            ...
                            <p className='text-[#17ff9a] mb-2'>0% Tax</p>
                            <p className='text-[#b6bdb9]'>Buy/Sell</p>
                        </div>
                        <div className='flex flex-col items-center'>
                            <div className='w-20 h-20 bg-linear-to-br from-[#0ea674] to-[#17ff9a] rounded-2xl flex items-center justify-center mx-auto mb-4'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" width="28px" height="28px" viewBox="0 0 32 32">
